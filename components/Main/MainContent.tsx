...
const MainCardLink = '/images/main-card-link.webp';
const MainCardControl = '/images/main-card-control.webp';
const MainCardShare = '/images/main-card-share.webp';
const MainCardSearch = '/images/main-card-search.webp';
...
function MainContent() {
  return (
    <>
      <MainTitle />
      {CARD_LIST.map((list: CardType, index: number) => {
